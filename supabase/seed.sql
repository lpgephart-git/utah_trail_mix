...
values
  ...
  (
    ...
    'ambitious', 2.6, 1305, 15,
    'Short but steep — a punchy foothill climb with a big payoff view of the valley. For the crowd that wants a workout without a long day. Trailhead at Red Butte Garden.',
