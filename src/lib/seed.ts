...
export const seedHikes: HikeWithCounts[] = [
  ...
  },
  {
    ...
    starts_at: "2026-10-03T14:30:00.000Z",
    difficulty: "ambitious",
    distance_miles: 2.6,
    elevation_gain_ft: 1150,
    notes:
      "Short but steep — a punchy foothill climb with a big payoff view. For the crowd that wants a workout without a long day. Free parking near the trailhead.",
    what_to_bring: "Water, sturdy shoes, layers, sunscreen.",
    capacity: 15,
    strava_embed: null,
    alltrails_url: "https://www.alltrails.com/trail/us/utah/mount-van-cott",
  ...
  },
  {
    ...
    capacity: null,
    strava_embed: null,
    alltrails_url: "https://www.alltrails.com/trail/us/utah/city-creek-canyon",
