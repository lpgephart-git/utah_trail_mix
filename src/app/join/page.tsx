  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-4 py-12 sm:px-6">
      ...
      <p className="mt-2 text-on-surface-variant">
        Connect with Utah educators focused on wellness and the outdoors. Pick a
        password and you&apos;re in — no email confirmation needed.
      </p>
      ...
      <form action={formAction} className="mt-8 flex flex-col gap-4">
        ...
        >
          {pending ? "Creating your account…" : "Count me in"}
        </button>
